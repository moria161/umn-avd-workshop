...
username arista ssh-key ssh-rsa  arista@umn-avd-workshop-11-4cafa1fb-eos
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_TelecomB-DV-1_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet4 | SERVER_TelecomB-HOST-1_eth2 | *access | *30 | *- | *- | 4 |
| Ethernet6 | MLAG_TelecomB-DV-1_Ethernet6 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_TelecomB-DS-1_Ethernet3 | - | 172.16.2.5/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_TelecomB-DS-2_Ethernet3 | - | 172.16.2.7/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description MLAG_TelecomB-DV-1_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description P2P_TelecomB-DS-1_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_TelecomB-DS-2_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description SERVER_TelecomB-HOST-1_eth2
   no shutdown
   channel-group 4 mode active
!
interface Ethernet6
   description MLAG_TelecomB-DV-1_Ethernet6
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_TelecomB-DV-1_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
| Port-Channel4 | SERVER_TelecomB-HOST-1 | access | 30 | - | - | - | - | 4 | - |
...
interface Port-Channel1
   description MLAG_TelecomB-DV-1_Port-Channel1
   no shutdown
...
interface Port-Channel4
   description SERVER_TelecomB-HOST-1
   no shutdown
...
!
interface Vxlan1
   description TelecomB-DV-2_VTEP
...
| 10.252.2.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | PROD | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 30 | 10.250.2.4:10030 | 10030:10030 | - | - | learned |
| 40 | 10.250.2.4:10040 | 10040:10040 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| PROD | 10.250.2.4:50001 | connected | - |
...
router bgp 65201
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description TelecomB-DV-1
   ...
   vrf PROD
      ...
      router-id 10.250.2.4
      neighbor 10.252.2.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.2.0 description TelecomB-DV-1_Vlan3001
