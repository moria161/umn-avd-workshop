...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_TelecomB-DB-1_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet6 | MLAG_TelecomB-DB-1_Ethernet6 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_TelecomB-DS-1_Ethernet8 | - | 172.16.2.21/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_TelecomB-DS-2_Ethernet8 | - | 172.16.2.23/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description MLAG_TelecomB-DB-1_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description P2P_TelecomB-DS-1_Ethernet8
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_TelecomB-DS-2_Ethernet8
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet6
   description MLAG_TelecomB-DB-1_Ethernet6
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_TelecomB-DB-1_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description MLAG_TelecomB-DB-1_Port-Channel1
   no shutdown
...
!
interface Vxlan1
   description TelecomB-DB-2_VTEP
...
| 10.252.2.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | PROD | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 30 | 10.250.2.8:10030 | 10030:10030 | - | - | learned |
| 40 | 10.250.2.8:10040 | 10040:10040 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| PROD | 10.250.2.8:50001 | connected | - |
...
router bgp 65203
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description TelecomB-DB-1
   ...
   neighbor 10.252.2.8 description TelecomB-DB-1_Vlan4093
   ...
   neighbor 172.16.2.22 description TelecomB-DS-2_Ethernet8
   ...
   vrf PROD
      ...
      router-id 10.250.2.8
      neighbor 10.252.2.8 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.2.8 description TelecomB-DB-1_Vlan3001
