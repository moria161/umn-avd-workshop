...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_AOC-DB-1_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet6 | MLAG_AOC-DB-1_Ethernet6 | *trunk | *- | *- | *MLAG | 1 |
...
!
interface Ethernet1
   description MLAG_AOC-DB-1_Ethernet1
   no shutdown
...
!
interface Ethernet6
   description MLAG_AOC-DB-1_Ethernet6
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_AOC-DB-1_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description MLAG_AOC-DB-1_Port-Channel1
   no shutdown
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description AOC-DB-1
   ...
   neighbor 10.252.1.8 description AOC-DB-1_Vlan4093
