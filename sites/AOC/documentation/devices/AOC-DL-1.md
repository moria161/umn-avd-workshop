...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_AOC-DL-2_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet4 | SERVER_AOC-HOST-2_eth1 | *access | *20 | *- | *- | 4 |
| Ethernet6 | MLAG_AOC-DL-2_Ethernet6 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_AOC-DS-1_Ethernet4 | - | 172.16.1.9/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_AOC-DS-2_Ethernet4 | - | 172.16.1.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description MLAG_AOC-DL-2_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description P2P_AOC-DS-1_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_AOC-DS-2_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description SERVER_AOC-HOST-2_eth1
   no shutdown
   channel-group 4 mode active
!
interface Ethernet6
   description MLAG_AOC-DL-2_Ethernet6
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_AOC-DL-2_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description MLAG_AOC-DL-2_Port-Channel1
   no shutdown
...
| 10.252.1.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | PROD | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 40 | 10.250.1.5:10040 | 10040:10040 | - | - | learned |
...
router bgp 65102
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description AOC-DL-2
   ...
   vrf PROD
      ...
      router-id 10.250.1.5
      neighbor 10.252.1.5 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.1.5 description AOC-DL-2_Vlan3001
