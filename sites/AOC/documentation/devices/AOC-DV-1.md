...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_AOC-DV-2_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet4 | SERVER_AOC-HOST-1_eth1 | *access | *10 | *- | *- | 4 |
| Ethernet6 | MLAG_AOC-DV-2_Ethernet6 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_AOC-DS-1_Ethernet2 | - | 172.16.1.1/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_AOC-DS-2_Ethernet2 | - | 172.16.1.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description MLAG_AOC-DV-2_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description P2P_AOC-DS-1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_AOC-DS-2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description SERVER_AOC-HOST-1_eth1
   no shutdown
   channel-group 4 mode active
!
interface Ethernet6
   description MLAG_AOC-DV-2_Ethernet6
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_AOC-DV-2_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
| Port-Channel4 | SERVER_AOC-HOST-1 | access | 10 | - | - | - | - | 4 | - |
...
interface Port-Channel1
   description MLAG_AOC-DV-2_Port-Channel1
   no shutdown
...
| 10.252.1.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | PROD | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ | ---------------- |
| PROD | 10.250.1.3:50001 | connected | - |
...
router bgp 65101
   ...
   neighbor 10.252.1.1 description AOC-DV-2_Vlan4093
   ...
   vrf PROD
      ...
      router-id 10.250.1.3
      neighbor 10.252.1.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.1.1 description AOC-DV-2_Vlan3001
